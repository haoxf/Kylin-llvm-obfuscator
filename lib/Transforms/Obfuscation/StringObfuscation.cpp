  ...
  virtual bool runOnModule(Module &M) {
    ...
    for (Module::global_iterator gi = M.global_begin(), ge = M.global_end();
      ...
      if (gv->isConstant() && gv->hasInitializer() && isa<ConstantDataSequential>(gv->getInitializer()) &&
        ...
        dynGV->setLinkage(GlobalValue::PrivateLinkage);
        dynGV->setVisibility(GlobalValue::HiddenVisibility);
...
private:
  void addDecodeFunction(Module *mod, std::vector<encVar *> *gvars) {
    ...
    fdecode->setLinkage(GlobalValue::PrivateLinkage);
    fdecode->setVisibility(GlobalValue::HiddenVisibility);
    ...
    if (!gvar_array_llvm_global_ctors) {
      ...
      gvar_array_llvm_global_ctors->setLinkage(GlobalValue::PrivateLinkage);
      gvar_array_llvm_global_ctors->setVisibility(GlobalValue::HiddenVisibility);
    } else {
